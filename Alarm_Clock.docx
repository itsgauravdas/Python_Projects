...
class AlarmApp(tk.Tk):
    def __init__(self):
        #Inheriting the Tk class of tkinter module
        tk.Tk.__init__(self)
        
        #Title 
        self.title('Alarm Clock')
        #Make it so user can't resize it 
        self.resizable(width=False,height=False)
        #set up all the drop down lists
        self.hr=tk.IntVar(self)
        self.min=tk.IntVar(self)
        self.ampm=tk.StringVar(self)
        #Set the initial values of each dropdown box
        self.hr.set('12')
        self.min.set('00')
        self.ampm.set('AM')
        ...
        self.popmenuAMPM=tk.OptionMenu(self,self.ampm,*amplist)
        ...
        self.cancelbutton=tk.Button(self,text="Cancel Alarm",command=self.stop_clock,state='disable')
    ...
    def stop_clock(self):
        ...
        print("Alarm set for {}:{}{} has been cancled".format(self.hr.get(), "%02d" % (self.min.get()),self.ampm.get()))
